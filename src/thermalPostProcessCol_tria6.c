/******************************************************************************
* File      : thermalPostProcessCol_tria6.c                                   *
...
#include "constants.h"
#include "thermalPostProcessCol_tria6.h"
                                ...
                                double **xColumns, double ***bi)
{
	...
	for(i = 0; i < nInternalPoints; i++){
   		...
   		if(count == nColumns){
			temperature_tria6(nInterp,b0,Xin,mNodes,mElems,vB,xi,yi,zi,bi,&T);
