/******************************************************************************
* File      : thermalPostProcessColAdapt_tria6.c                              *
...
#include "constants.h"
#include "thermalPostProcessColAdapt_tria6.h"
                                     ...
                                     double **xColumns, evalNode *integralNodes)
{
	...
	fprintf(file_log,"\n\tthermalPostProcessColAdapt_tria6(): ");
	...
	for(i = 0; i < nInternalPoints; i++){
   		...
   		if(count == nColumns){
			temperatureAdapt_tria6(Xin,mNodes,mElems,vB,integralNodes,&T);
