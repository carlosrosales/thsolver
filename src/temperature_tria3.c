/******************************************************************************
* File      : temperatureAdaptive_tria3.c                                     *
...
#include "constants.h"
#include "temperature_tria3.h"

int temperature_tria3(int *nInterp, double b0, double *Xin, double **mNodes, 
