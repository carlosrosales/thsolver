/******************************************************************************
* File      : thermalPostProcessAdaptCol_tria6.h                              *
...
int temperatureAdapt_tria6(double *Xin, double **mNodes, unsigned int **mElems,
                           double *vB, evalNode *integralNodes, double *T);

/* Global variables */
extern FILE *file_log;
extern unsigned int domainSize, nElems, nInternalPoints, nColumnType;
