/******************************************************************************
* File      : thermalPostProcessCubat_tria6.c                                 *
...
#include "constants.h"
#include "thermalPostProcessCubat_tria6.h"
	...
	for(i = 0; i < NT; i++){
		...
		for(j = 0; j < NT; j++){
			...
			for(k = 0; k < NT; k++){
				...
				temperatureCubat_tria6(Xin,mNodes,mElems,vB,cellNodes,cells,
				b,&T);
				Tstats[Tcount] = T;
				Tmean += T;
				Tcount++;
